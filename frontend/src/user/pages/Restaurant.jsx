...
const restaurantData = [
  {
    ...
    media: ['/images/2.png', '/images/3.png']
  },
  {
    id: 'district',
    name: 'Bar Lounge',
    ...
    media: ['/videos/3video.mp4', '/images/4.png']
  },
  {
    id: 'food-menu',
    name: 'Food Menu',
    ...
    media: ['/images/8.png', '/images/9.png', '/images/10.png', '/images/11.png','/images/14.png','/images/15.png','/images/16.png','/images/17.png']
  }
];
  ...
  return (
    <div className="restaurant-page">
      ...
      <div className="header-image-container">
        <img src="/images/13.png" alt="Restaurant Banner" className="header-banner" />
